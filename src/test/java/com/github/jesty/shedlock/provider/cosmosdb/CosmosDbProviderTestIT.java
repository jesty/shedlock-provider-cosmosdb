 ...
 */
package com.github.jesty.shedlock.provider.cosmosdb;
...
public class CosmosDbProviderTestIT extends AbstractLockProviderIntegrationTest {
    ...
    public void initConnection() throws IOException {
        ...
        p.load(new InputStreamReader(CosmosDbProviderTestIT.class.getClassLoader().getResourceAsStream("config.properties")));
